...
namespace IdSvrHost.UI.Consent
{
    ...
    {
        public ConsentViewModel(ConsentInputModel model, string consentId, AuthorizationRequest request, Client client, IEnumerable<Scope> scopes, ILocalizationService localization)
        {
