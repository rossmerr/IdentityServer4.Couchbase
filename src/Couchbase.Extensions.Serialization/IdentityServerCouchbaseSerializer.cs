...
{
    public class IdentityServerCouchbaseSerializer : IExtendedTypeSerializer
    {
        public static Func<ITypeSerializer> GetSerializer()
        {
            return () => new IdentityServerCouchbaseSerializer(new ClaimConverter());
        }

        #region Constructors

        public IdentityServerCouchbaseSerializer(params JsonConverter[] jsonConverters) : this(
        ...
        public IdentityServerCouchbaseSerializer(JsonSerializerSettings deserializationSettings, JsonSerializerSettings serializerSettings)
        {
        ...
        /// </returns>
        /// <remarks>
        /// IdentityServerCouchbaseSerializer uses <see cref="JsonSerializerSettings.ContractResolver"/> from <see cref="SerializerSettings"/>
